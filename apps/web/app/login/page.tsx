            ...
            <div className="space-y-8 pt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="flex items-center justify-center rounded-full border border-[var(--color-outline-variant)]/30 py-4 transition-all duration-300 hover:border-ink/40"
                >
                ...
                >
                  ...
                  <span className="text-[0.65rem] font-semibold tracking-[0.1em]">APPLE</span>
                </button>
              </div>
            </div>
          </form>
